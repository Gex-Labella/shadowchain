...
graph TB
    subgraph Collator["Shadowchain Collator"]
        BP[Block Production<br/>• Collect transactions from mempool<br/>• Build parachain blocks<br/>• Create Proof of Validity]
        RCI[Relay Chain Interface<br/>• Submit PoV to relay chain validators<br/>• Receive finalized relay chain headers<br/>• Process downward messages]
        XCM[XCM Processor<br/>• Handle cross-chain messages<br/>• Execute remote shadow verifications<br/>• Process asset transfers]
