//! Test mock runtime for the Shadow pallet

use crate as pallet_shadow;
use frame_support::{
    parameter_types,
    traits::{ConstU16, ConstU32, ConstU64, ConstU128, OnFinalize, OnInitialize},
};
...
parameter_types! {
    ...
    pub const MaxItemsPerAccount: u32 = 1000;
}
...
// Helper function to run to the next block
